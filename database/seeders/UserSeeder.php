...
class UserSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('users')->updateOrInsert(['email' => 'hr@example.com'], [
            ...
            'role' => UserRole::Hr->value, 'unit_id' => $units['Sumber Daya Manusia'], 'position_id' => $positions['Admin SDM'],
            'employee_number' => 'HR-001', 'is_active' => true,
            'created_at' => $now, 'updated_at' => $now,
        ]);
        DB::table('users')->updateOrInsert(['email' => 'atasan@example.com'], [
            'name' => 'Atasan Demo', 'email_verified_at' => $now, 'password' => $password,
            'role' => UserRole::Manager->value, 'unit_id' => $units['Operasional'], 'position_id' => $positions['Kepala Bagian'],
            'employee_number' => 'MGR-001', 'is_active' => true,
            'created_at' => $now, 'updated_at' => $now,
        ]);
        ...
        foreach (range(1, 5) as $index) {
            ...
            DB::table('users')->updateOrInsert(['email' => "pegawai{$suffix}@example.com"], [
                ...
                'role' => UserRole::Employee->value, 'unit_id' => $units['Operasional'], 'position_id' => $positions['Kepala Bagian'],
